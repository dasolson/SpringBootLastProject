        ...
        <div class="card h-100">
          ...
          <div class="card-body" id="food_list">
          	<table class="table">
          		...
          		<tr v-for="(vo, index) in store.food_list" :key="index" @click="store.foodSelect(vo.contentid, vo.title, vo.image1)" class="link">
          			<td>
        ...
        <div class="card">
          ...
          <div class="card-body text-center">
            <div class="d-flex justify-content-center gap-2 flex-wrap" v-show="store.isTime">
              <span class="btn btn-xs btn-success" v-for="(t, i) in store.time_list" :key="i" style="margin-left: 2px" @click="store.timeSelect(t)">
              	{{t}}
              </span>
            </div>
          </div>
        ...
        <div class="card">
          ...
          <div class="card-body text-center">
            <div class="d-flex justify-content-center gap-2 flex-wrap" v-if="store.isInwon">
              <span class="btn btn-xs btn-warning" v-for="(t, i) in store.inwon_list" :key="i" style="margin-left: 2px" @click="store.inwonSelect(t)">
              	{{t}}
              </span>              
            </div>
          </div>
