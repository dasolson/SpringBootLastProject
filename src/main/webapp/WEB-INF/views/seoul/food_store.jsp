		    ...
		    <table class="table">
		    	<tbody>
			      <tr>
				    ...
				    <tr>
					    <td width="15%" class="text-center">대표메뉴</td>
			          ...
			          <div class="comment-content">
			            ...
			            <div class="comment-form" style="padding-top:5px" v-if="store.reReplyNo===rvo.no">
			              <form action="#" method="post" >			           
			                ...
			                <button type="button" class="btn-primary" style="float: left;width: 80px;height: 100px;display: inline-block;"  @click="store.replyReply(rvo.no)">댓글</button>
			              </form>
			            </div>
			          </div>                                            
			          </div>                                        			                                                                        
