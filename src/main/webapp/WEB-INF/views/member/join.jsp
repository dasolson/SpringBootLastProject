			     ...
			     <form id="frm" name="frm" method="post" action="/member/join_ok">
			      <table class="table table-bordered table-hover">
			        ...
			        <tr>
			          ...
			          <td><input type="text" ref="addr1" name="addr1" class="form-control input-sm" v-model="addr1" readonly></td>
			        </tr>			
			        <tr>
			        ...
			        <tr>
			          ...
			          <td>
			            <div class="form-inline">
			              <select name="phone1" class="form-control input-sm" v-model="phone">
			                <option>010</option>
			                <option>011</option>
			                <option>016</option>
			              </select>
