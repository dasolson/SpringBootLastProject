...
/*
 *      0106
 *      1주. 일반 보안 => 자동 로그인 => 프로시저 / 트리거 / 람다식
 *      2주. JWT => 카카오 / 구글 로그인 
 *      3주. 소켓 : 실시간 : 그룹 채팅 / 1:1 채팅 => Spring AI (챗봇)
 *      4주. 실시간 메세지 전송 : Kafka / batch
 *      5주. MSA : React => NodeJS => JPA / MySQL
 *      6주. CI/CD => 통합 => Spring Data => elasticSearch / Redis
 *      
 *      AI
 */
import java.util.*;
