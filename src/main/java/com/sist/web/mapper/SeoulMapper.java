...
public interface SeoulMapper {
	 ...
	 * <select id="seoulListData" resultType="com.sist.web.vo.SeoulVO" parameterType="hashmap">
	 		SELECT no, contentid, title, address, image1
	 		FROM seoultravel
	 ...
	 * <select id="seoulTop5Data" resultType="com.sist.web.vo.SeoulVO">
	 		...
	 		FROM seoultravel WHERE ontenttype=39 ORDER BY hit DESC)
	 		WHERE rownum&lt;=5	 		
	 	</select>
	 */
	...
	@Select("SELECT f.no, image1, x, y, title, address, "
			+ "f.contentid, eventstartdate, eventenddate, agelimit, playtime, eventplace, eventhomepage, usetime, spendtime, msg "
